...
public class NoticeBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseFirestore = FirebaseFirestore.getInstance();
        documentReference  =  firebaseFirestore.collection("Notificatios__User").document();
    ...
    private void reciveData() {
        ...
        firebaseFirestore.collection("Notificatios__User").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override

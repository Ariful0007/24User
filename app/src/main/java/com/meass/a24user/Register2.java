...
private AutoCompleteTextView editTextPassword111;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPassword111.setThreshold(1);//will start working from first character
        editTextPassword111.setAdapter(adapter);//setting the adapter data into the AutoCompleteTextView
        editTextPassword111.setTextColor(Color.RED);
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(editTextPassword111.getText().toString())||TextUtils.isEmpty(edtname.getText().toString())
                    ...
                    warning.setTitle("Conformation")
                            .setMessage("Are You Want To Registeration Using User Refer")
                                                                                                                                        ...
                                                                                                                                        if (task.isSuccessful()) {
                                                                                                                                            ...
                                                                                                                                            firebaseFirestore.collection("Name_Exsiting")
                                                                                                                                                    ...
                                                                                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                                                        ...
                                                                                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                                                                                            if (task.isSuccessful()) {
                                                                                                                                                                old_user(edtnumber.getText().toString().toLowerCase());
